...
Add #2+#3 (UBL/Peppol, 7d), #5 (free-text email LLM, 2d), #8 (SFTP pull, 4d), #9 (OCR, 5d), #14 (network-effect mapping, 5d). Cumulative ~42 days, fits 13 weeks with buffer for support and bugfixes.
