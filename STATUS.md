...
> - **Wave 7 REMAINING:** delivery channels (HTTP/webhook via webhook.site; SFTP/FTPS/SMTP via a public test host or mark "Configurable"; S3 throwaway bucket; ERP=mock REST per founder), API-key ingress + inbound-email (simulate Postmark webhook), admin UI walk, Sentry/PostHog event verification.
