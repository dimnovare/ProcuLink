...
## Where we are: **2026-06-06 (latest) — full P1/P2/P3 audit sweep shipped + runtime-verified**
...
> - **Deferred (intentional):** SpineReview header-field editing kept **read-only** — re-enabling needs a resolve-DTO header-field backend change (its own careful PR; it writes the canonical model). Long-tail P3 polish remains in the audit doc.
