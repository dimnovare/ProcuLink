...
public class ConnectionRevisionTransportSecurityTests
{
        ...
        ProcuLinkDbContext db, SupplierConnectionService svc)
    {
        ...
        // nothing. The subject here is the transport policy, not the evidence gate — but reaching
        // Published legitimately requires the pack to have exercised the revision.
