...
public sealed class TransformBuyerNamePostgresTests(PostgresContainerFixture postgres) : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _databaseConnectionString = await postgres.CreateDatabaseAsync("proculink_buyer");
