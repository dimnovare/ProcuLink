...
public sealed class DeliveryCrashRecoveryPostgresTests(PostgresContainerFixture postgres) : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _databaseConnectionString = await postgres.CreateDatabaseAsync("proculink_crashrec");
