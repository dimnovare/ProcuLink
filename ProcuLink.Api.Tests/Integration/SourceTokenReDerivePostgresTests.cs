...
public sealed class SourceTokenReDerivePostgresTests(PostgresContainerFixture postgres) : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _databaseConnectionString = await postgres.CreateDatabaseAsync("proculink_rederive");
