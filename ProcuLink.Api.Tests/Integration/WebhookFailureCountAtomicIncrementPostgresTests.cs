...
public sealed class WebhookFailureCountAtomicIncrementPostgresTests(PostgresContainerFixture postgres) : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _databaseConnectionString = await postgres.CreateDatabaseAsync("proculink_whfail");
